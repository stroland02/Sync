...
| CI-W415 | Decision 61 on my three tables -- an empty table keeps its headers so the shape of the data is legible before there is data, and decision 63 forbids shortening the sentences while I move them | claimed | `web/src/components/data-table.tsx`, `web/src/features/` |
