...
| M7-W160 | The chassis: one sidebar at two widths, a page header, and the two DESIGN.md refusals reversed on measurement. B116 filed, B115 re-measured | pushed, `m7-chassis`, not merged | `briefs/2026-08-06-m7-the-chassis.md` |
