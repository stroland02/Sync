...
| CI-W406 | The indexing canvas stops rendering one nothing for two facts -- never-indexed told apart from indexed-and-found-none, and off-path bindings shown as a place rather than dropped | claimed | `web/src/features/index-graph/` |
