...
| M7-W163 | Phase 4: the Fleet level onto the chassis, and the display step proven on a feature route. Type range 2.67 to 4.00, side-by-side placements 1 to 4. B119, B120, B121 filed | pushed, `m7-fleet`, not merged | `briefs/2026-08-06-m7-phase4-fleet.md` |
