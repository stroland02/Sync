...
| CI-W435 | Beta readiness scoped against the tree rather than the plan -- B188 answered by the owner as bake-a-spec AND ship --repo, all three install paths in scope, and the README split | claimed | `docs/superpowers/plans/`, `README.md` |
