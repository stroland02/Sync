...
| M7-W164 | Phase 4: the Binding surface and Vendor levels, and the two components named `ControlBar`. B115 re-measured — 1280 is one pixel short | landed on `m7-bindings` | `briefs/2026-08-06-m7-phase4-binding-surface.md` |
