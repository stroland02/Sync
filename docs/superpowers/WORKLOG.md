...
| CI-W450 | Gate 3 not walked and deliberately not signed: the console never went quiet long enough, measured -- longest gap in 82 minutes was 23 against a 25-minute bar | claimed | `docs/superpowers/reports/` |
