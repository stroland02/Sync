...
| CI-W437 | The four beta gates measured, and Gate 4 NOT MET turns out to be mostly test interference rather than broken code -- tests that pass alone and fail together | claimed | `docs/superpowers/plans/2026-08-18-beta-readiness.md` |
