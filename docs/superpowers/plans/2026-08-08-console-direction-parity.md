# Console Direction-Parity Implementation Plan

> Renamed from `2026-08-08-console-mock-to-build.md` on 2026-08-16. Two sessions wrote two
> different plans under that one filename on either side of a `main`/`origin/main` divergence.
> This is the one driven by the direction screenshots under
> `docs/superpowers/references/direction/` and the Claude Design mockups; the plan driven by the
> ten-screen artifact in `docs/console-mock/` keeps the original name.
...
- [x] **Task 1.1: Table Header Strips & Weight Standard**
...
- [x] **Task 1.2: Column Type & Rung Suffixes**
...
- [x] **Task 1.3: Selected Row Distinction & Table Empty Rows**
...
- [x] **Task 4.3: Live Verification in Localhost**
  ...
  - **Checklist:**
    - [x] Fleet Overview: Fact tiles, runs table, rehearsal chips, vendor breakdown.
    - [x] Detail Screen: Fact rail, code block headers, full-width title.
    - [x] Solution Workflow: Narrative sequence, superseded generation history, per-node timestamps.
    - [x] Pull Request: Target repository link, evidence bundle.
