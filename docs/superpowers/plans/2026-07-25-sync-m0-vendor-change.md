...
- **No test makes a network call or a model call.** Fixtures are committed. The single end-to-end test in Task 11 is the sole exception and is marked `@pytest.mark.e2e`, deselected by default.
