...
- **npm**: `@builder.io/sdk`, `@builder.io/react`, `@builder.io/sdk-react`
...
Official documentation: [https://www.builder.io/c/docs/developers](https://www.builder.io/c/docs/developers)
