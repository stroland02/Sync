...
- **npm**: `@dynatrace/oneagent-sdk`, `@dynatrace-sdk/client-classic-environment-v2`
- **pypi**: `oneagent-sdk`
...
Official documentation: [https://developer.dynatrace.com](https://developer.dynatrace.com)
