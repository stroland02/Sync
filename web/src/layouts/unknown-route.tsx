  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      <p className="text-sm text-muted-foreground">
        The console has three levels: the codebase overview, a vendor, and a finding.
        Nothing was asked of the API for <code className="font-mono">{pathname}</code>.
      </p>
      <Link to="/" className="text-sm underline underline-offset-2">
        Back to the codebase overview
      </Link>
    </section>
  )
}
