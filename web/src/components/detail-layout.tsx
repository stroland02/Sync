...
export function DetailLayout({
  ...
  list: ReactNode
  /** `null` closes the panel and gives the list the whole width. */
        ...
        >
          <div className="flex items-start justify-between gap-row border-b border-line pb-row">
            ...
            <button
              ...
              className="shrink-0 rounded-control p-field text-ink-muted transition-colors hover:bg-surface-subtle hover:text-ink focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
            >
